    ...
    <div className='section2-container'>
        <div className='section2-comp'>
            <div className='comp-left'>
                ...
                <p className='compl-cont2'>Vulnerabilities could allow users to mint CDP tokens or pension shares indefinitely, disrupting the system's economic balance.</p>
            </div>
